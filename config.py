...
LOGGER_ID = int(getenv("-1002295126057"))

# Get this value from @BRANDRD_ROBOT on Telegram by /id
OWNER_ID = int(getenv("5567910560"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/mm_tgmusic")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/mm_tgmusic_chat")
